...
#include <math.h>
#include <stdlib.h>
#define NUM_BLOCKS 10  // Total number of blocks
...
void menu()
{
    ...
    while (1)
    {
        ...
        case 6:
            ...
            scanf("%d", &id);
            display_contiguous_file(&contiguous_files[id]);
            break;
        case 7:
            printf("Enter file index: ");
            scanf("%d", &id);
            ...
            scanf("%d", &id);
            logical_delete_contiguous(&contiguous_files[id], id);
            break;
        case 8:
            printf("Enter file index: ");
            scanf("%d", &id);
            ...
            scanf("%d", &id);
            physical_delete_contiguous(&contiguous_files[id], id);
            break;
        case 9:
            compact_memory();
